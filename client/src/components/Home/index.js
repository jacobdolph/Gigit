          ...
          <div className='main-landing'>
            <div className='overlay'>
              <div className='overlay-elements'>
                ...
                <p>Why Gigit?</p>
                <p>
                  Gigit is a third party application that lets average people
                  get top notch talent for their event. A user can Sign up,
                  select a gig, choose the right Gigger for their event and then
                  gig them! This app also lets people create their own gigs If
                  they feel they have what it takes!
                </p>
              </div>
            </div>
          </div>
